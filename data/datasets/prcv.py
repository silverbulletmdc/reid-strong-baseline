...
class PRCVDataset(BaseImageDataset):
    """
    Market1501
    Reference:
    ...
    def __init__(self, root='./datasets', verbose=True, **kwargs):
        super(PRCVDataset, self).__init__()
...
class PRCVNori(BaseImageDataset):
    """
    Market1501
    Reference:
    Zheng et al. Scalable Person Re-identification: A Benchmark. ICCV 2015.
    ...
    def __init__(self, root="s3://normal/veri776/", verbose=True, **kwargs):
        ...
        self.gallery, self.gallery_label2pid, self.gallery_pid2label = self._process_dir(self.gallery_dir,
                                                                                         relabel=False)
