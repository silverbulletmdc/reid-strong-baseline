...
from exp.attention_transductive.attention_train import make_data_loader
...
def build_model(cfg, num_classes):
    ...
    small_model = Baseline(num_classes, cfg.MODEL.LAST_STRIDE, cfg.MODEL.PRETRAIN_PATH, cfg.MODEL.NECK,
